    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (minIn.getText() != null && maxIn.getText() != null) {
                ...
                minYear = Integer.parseInt(minIn.getText().toString());
                maxYear = Integer.parseInt(maxIn.getText().toString());
                ...
                stream.filter(s -> s.getOpeningYear() >= minYear && s.getOpeningYear() <= maxYear).forEach(a -> output.append(a.getSymbol() + " " + a.getOpeningYear() + "\n"));
